...
@Component({
  selector: 'app-historique-contrat-vie-a',
  standalone: false,
  templateUrl: './historique-contrat-vie-a.component.html',
  styleUrl: './historique-contrat-vie-a.component.css'
})
export class HistoriqueContratVieAComponent {
  cin: string = '';
  contrats: any[] = [];
  user: any = null;
  ...
  searchContrats(): void {
    if (!this.cin || this.cin.length !== 8 || !/^\d+$/.test(this.cin)) {
