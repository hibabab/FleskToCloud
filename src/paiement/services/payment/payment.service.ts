...
export class PaymentService {
    ...
    async generatePaymentLink(
        ...
        try {
          ...
          this.logger.log(`Vérification du montant d'échéance: ${contrat.montantEcheance}`);
          if (!contrat.montantEcheance || contrat.montantEcheance <= 0) {
            this.logger.error(`Montant d'échéance invalide pour le contrat ${contratNum}: ${contrat.montantEcheance}`);
          ...
          const payment = this.paymentRepository.create({
            ...
            amount: contrat.montantEcheance,
            status: 'PENDING',
            contrat: contrat,
          });
          ...
          try {
            ...
            this.logger.log(`Préparation de l'appel API Flouci avec montant: ${Math.round(contrat.montantEcheance * 1000)}`);
            ...
            const requestParams = {
              ...
              amount: Math.round(contrat.montantEcheance * 1000).toString(),
              accept_card: 'true',
            ...
            const response = await firstValueFrom(
              this.httpService.post(
                'https://developers.flouci.com/api/generate_payment',
                {
                  ...
                  amount: Math.round(contrat.montantEcheance * 1000).toString(), // Conversion en millimes
                  accept_card: 'true',
